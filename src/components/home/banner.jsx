  ...
  return (
    <div className='flex flex-col content-center items-center mb-28 mt-36 md:flex-row'>
        <div className='flex flex-col content-center items-center md:w-8/12 md:block'>
            ...
            <p className=" text-blue-600 text-2xl flex animate-pulse md:hidden font-rubik ">NĂNG ĐỘNG & SÁNG TẠO</p>
           ...
           <button className='flex items-center content-center rounded-3xl border-2 border-blue-400 py-2 px-6 hover:text-white hover:border-black hover:bg-blue-400 hover:rounded-3xl hover:shadow-2xl hover:shadow-gray-600 dark:hover:border-white dark:shadow-white md:py-3'>
            <button className='mr-2 text-xl'><AiOutlineArrowDown/></button>
            <p><a href="#about" className="font-sigmar">CHI TIẾT</a></p>
           </button>
        </div>
